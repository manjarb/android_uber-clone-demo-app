...
public class DriverLocationActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        Log.i("Inyo", "onMapReady");

        intent = getIntent();


        ConstraintLayout driverMapLayout = (ConstraintLayout) findViewById(R.id.driverMapLayout);
        driverMapLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            @Override
            public void onGlobalLayout() {
                ...
                Log.i("requestLocation", requestLocation.toString());
